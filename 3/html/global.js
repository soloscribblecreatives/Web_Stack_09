...
switch(pg_id){
	case 1:
	content = '<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="s1"><img src="slide1/s1.png" width="1180" height="775" alt=""/></div><div class="s2"><img src="slide1/s2.png"/></div><div class="s3"><img src="slide1/s3.png"/></div><div class="s4w"><div class="s4"><img src="slide1/s4.png"/></div></div>';
	break;
	case 2:
	content = '<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="s1"><img src="slide2/s1.png" width="1180" height="775" alt=""/></div><div class="hit_1"><img src="slide2/pop1.png" width="1180" height="775" alt=""/></div><div class="hit_pop1" onclick="hit_pop1()"></div><div class="hit_2"><img src="slide2/pop2.png" width="1180" height="775" alt=""/></div><div class="hit_pop2" onclick="hit_pop2()"></div><div class="hit_close1" onclick="hit_close1()"></div>';
	break;
}
